...
class _AddPageState extends State<AddPage> {
  ...
  */
    ...
    final List<DropdownMenuItem<String>> modelMenu = model
        .map(
          (String value) => DropdownMenuItem<String>(
        value: value,
        child: Text(value),
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Image(
                  height: 200,
                alignment: Alignment.center,
                  image: AssetImage('assets/tablette.jpg'),
                ...
                child: Container(
                  ...
                  onPressed: () async{
                         //  Map <String,dynamic> data = {
                            // "reference": _numeroSerie.text , "modele" : _modele.text};
                     ...
                     Designation:_modele.text,
                      ...
                      final file = await PdfInvoiceApi.generate(invoice);
                       ...
                       PdfApi.openFile(file);
                          ...
                          // Navigator.of(context).push(MaterialPageRoute(builder: (context)=>MenuPage(modele: _modele.text, numeroSerie: _numeroSerie.text)))
